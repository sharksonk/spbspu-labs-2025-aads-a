...
void guseynov::graphs(const GraphCollection & graphs, std::ostream & out)
{
...
void guseynov::vertexes(const GraphCollection & graphs, std::istream & in, std::ostream & out)
{
...
void guseynov::outbound(const GraphCollection & graphs, std::istream & in, std::ostream & out)
{
...
void guseynov::inbound(const GraphCollection & graphs, std::istream & in, std::ostream & out)
{
  std::string graphName, vertexName;
  if (!(in >> graphName >> vertexName))
  {
...
void guseynov::bind(GraphCollection & graphs, std::istream & in)
{
...
void guseynov::cut(GraphCollection & graphs, std::istream & in)
{
  std::string graphName, from, to;
  unsigned weight;
  if (!(in >> graphName >> from >> to >> weight))
...
void guseynov::create(GraphCollection & graphs, std::istream & in)
{
  std::string graphName;
  if (!(in >> graphName))
  {
...
void guseynov::merge(GraphCollection & graphs, std::istream & in)
{
...
void guseynov::extract(GraphCollection & graphs, std::istream & in)
{
