...
void sharifullina::getGraphs(std::ostream & out, const map & graphs)
{
  if (graphs.empty())
  {
    out << '\n';
...
void sharifullina::getVertexes(std::istream & in, std::ostream & out, const map & graphs)
{
...
void sharifullina::getOutbound(std::istream & in, std::ostream & out, const map & graphs)
{
...
void sharifullina::getInbound(std::istream & in, std::ostream & out, const map & graphs)
{
  std::string graphName, vertexName;
  in >> graphName >> vertexName;
  const Graph & graph = graphs.at(graphName);
...
void sharifullina::createEdge(std::istream & in, map & graphs)
{
...
void sharifullina::deleteEdge(std::istream & in, map & graphs)
{
  std::string graphName, v1, v2;
  int weight = 0;
  in >> graphName >> v1 >> v2 >> weight;
...
void sharifullina::createGraph(std::istream & in, map & graphs)
{
  std::string graphName;
  in >> graphName;
...
void sharifullina::mergeGraph(std::istream & in, map & graphs)
{
...
void sharifullina::extractGraph(std::istream & in, map & graphs)
{
